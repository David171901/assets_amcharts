    ...
    symbolVis.prototype.init = function(scope, elem, timeProvider) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                // console.log(" ~ file: sym-verticalbarsv2.js ~ line 79 ~ myCustomDataUpdateFunction ~ customStartDate", customStartDate)
        ...
        function fillDataArray(firstTurn, secondTurn, firstTurnReal, secondTurnReal, start, daysOfMonth, dataArray) {
            ...
            // console.log(" ~ file: sym-verticalbarsv2.js ~ line 112 ~ fillDataArray ~ todayDate", todayDate)
            ...
            for (let dayIndex = 1; dayIndex <= (daysOfMonth + moreDays) ; dayIndex++) {
                ...
                let newDataObject = getNewDataObject(iterableDate.getDate(), floatFirstTurn, floatSecondTurn, total, media);
                dataArray.push(newDataObject);
                }
                else{
                    let newDataObject = getNewDataObject(iterableDate.getDate(), null, null, null, null);
                    dataArray.push(newDataObject);
                }
            }     
        }
        ...
        function getNewDataObject(dayIndex, firstTurnValue, secondTurnValue, total, media ) {
            ...
            return AmCharts.makeChart(symbolContainerDiv.id, {
                ...
                "graphs": [{
                    ...
                    },
                    {
                        ...
                        "balloonText": scope.config.titlegraph3 + `</b><br />[[timestamp]]</b><br />[[${scope.config.graph3Value}]] ` + scope.config.labelunit ,
                        "valueField": "total",
