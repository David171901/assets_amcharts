(function (CS) {
    ...
    var myEDcolumnDefinition = {
        typeName: "BarrasvsTarg",
        displayName: 'Barras vs Target',
    ...
    symbolVis.prototype.init = function (scope, elem) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                var dailyDepuredValues = dailyItems.Values.filter(item => new Date(item.Time).getHours() == 23 && new Date(item.Time).getMinutes() == 59);
                ...
                for (var dayIndex = 1; dayIndex < daysOfMonth + 1; dayIndex++) {
                    ...
                    //if (dailyItemValue) dailyItemValue = dailyItemValue.toFixed(scope.config.decimalPlaces);
