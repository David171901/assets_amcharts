(function (BS) {
  ...
  symbolVis.prototype.init = function (scope, elem) {
    ...
    function myCustomDataUpdateFunction(data) {
      console.log(" ~ file: sym-parettochart.js:59 ~ myCustomDataUpdateFunction ~ data", data)
      dataArray = [];
      if (data) {
        ...
        console.log("🚀 ~ file: sym-parettochart.js:84 ~ dataArray=data.Data.map ~ dataArray", dataArray)
