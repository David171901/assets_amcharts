(function (CS) {
  var myEDcolumnDefinition = {
    typeName: "barrasfallasv6",
    displayName: "Diagrama de Barras Eventos con tarjets test balonn",
    inject: ["timeProvider"],
  ...
  symbolVis.prototype.init = function (scope, elem, timeProvider) {
    ...
    function myCustomDataUpdateFunction(data) {
      ...
      if (DATA !== null && DATA.Data) {
        ...
        let targetDefault = data.Data[3]?.Values[0]?.Value || -10;
        // Target UP
          ...
          graphs: [
            {
              ...
              balloonText:
                ...
                "[[timestamp]]</b><br />[[turno1]] " +
                "<h2>Eventos:</h2>" +
                `${
                  "[[turno2]]" != null
                    ? "Averías de Instrumentos : [[turno2]]"
                    : ""
                }` +
                `${
                  "turno3" != null
                    ? "</b><br /> Averías Eléctricas : [[turno3]]"
                    : ""
                }` +
                `${
                  "[[turno4]]" != null
                    ? "</b><br /> Averías Mecánicas : [[turno4]]"
                    : ""
                }` +
                `${
                  "[[turno5]]" != null
                    ? "</b><br /> Funcionamiento : [[turno5]]"
                    : ""
                }` +
                `${
                  "[[turno6]]" != null
                    ? "</b><br /> Influencia Externa : [[turno6]]"
                    : ""
                }` +
                `${
                  "[[turno7]]" != null
                    ? "</b><br /> Mantenimiento Planificado : [[turno7]]"
                    : ""
                }` +
                `${
                  "[[turno7]]" != null
                ...
                `${
                  "[[turno8]]" != null
                    ? "</b><br /> Seguridad : [[turno9]]"
                    : ""
                }` +
                `${
                  "[[turno9]]" != null
                    ? "</b><br /> Stand By : [[turno10]]"
                    : ""
                }` +
