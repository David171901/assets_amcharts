(function (CS) {
    ...
    var myEDcolumnDefinition = {
        typeName: "BarrasSobrepuestas",
        displayName: 'Barras sobrepuestas',
    ...
    symbolVis.prototype.init = function (scope, elem) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                if (firstTurn.Values.length > 0) {
                    ...
                    fillDataArray(firstTurn, secondTurn, firstTurnReal, secondTurnReal, monthNow, daysOfMonth, dataArray, targetArray)
        ...
        function fillDataArray(firstTurn, secondTurn, firstTurnReal, secondTurnReal, monthNow, daysOfMonth, dataArray, targetArray) {
            ...
            for (var dayIndex = 1; dayIndex < daysOfMonth; dayIndex++) {
                ...
                var valTarget = getValTarjet(targetArray);

                var newDataObject = getNewDataObject(dayIndex, floatFirstTurn, floatSecondTurn, total, valTarget);
        ...
        function getValTarjet(targetArray) {
            return parseFloat(("" + targetArray.Values[targetArray.Values.length - 1].Value).replace(",", "."));
        }

        function getNewDataObject(dayIndex, firstTurnValue, secondTurnValue, total, valTarget) {
            return {
                "timestamp": startDate.getDate() + "/" + monthSearch,
