...
(function (CS) {
    ...
    var myEDcolumnDefinition = {
        typeName: "LineaDiaVsTargetG7",
        displayName: 'Linea diaria vs Target G7',
    ...
    symbolVis.prototype.init = function (scope, elem) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                var dailyDepuredValues = dailyItems.Values.filter(item => new Date(item.Time).getHours() == 7 && new Date(item.Time).getMinutes() ==0);
