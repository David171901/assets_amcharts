  ...
  symbolVis.prototype.init = function (scope, elem, timeProvider) {
    ...
    function timeModels(data, disponibilidad) {
      return [
        ...
        { Label: "RP", Value: filterToModelTime("RP", data), Color: colors[2] },
        { Label: "RG", Value: filterToModelTime("RG", data), Color: colors[3] },
        { Label: "RE", Value: filterToModelTime("RE", data), Color: colors[4] },
    ...
    // Funcion calcular disponibilidad
