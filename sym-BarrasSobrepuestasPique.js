(function (CS) {
    ...
    var myEDcolumnDefinition = {
        typeName: "BarrasSobrepuestasPique",
        displayName: 'Barras sobrepuestas Pique',
    ...
    symbolVis.prototype.init = function (scope, elem) {
        ...
        function getSecondTurnRealValue(turnValue, dayIndex, currentDay, currentHour, secondTurnReal) {            
            if (dayIndex == currentDay && (currentHour >= 19 && currentHour < 24))
                return secondTurnReal.Values[secondTurnReal.Values.length - 1].Value;
            else if ((dayIndex - 1) == currentDay && (currentHour >= 0 && currentHour < 7))
                return secondTurnReal.Values[secondTurnReal.Values.length - 1].Value;
