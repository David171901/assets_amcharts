(function (CS) {
  ...
  var myEDcolumnDefinition = {
    typeName: "RendimientoPlantaBarrasv3",
    displayName: "Rendimiento Planta Barras v3",
  ...
  symbolVis.prototype.init = function (scope, elem, timeProvider) {
    ...
    function myCustomDataUpdateFunction(data) {
      ...
      if (data !== null && data.Data) {
        ...
        // MAQUINAS ************************************
        //   MOLINO PRIMARIO
        let gearOne = data.Data[15];
        // MOLINO KOPPER
        let gearTwo = data.Data[16];
        // MOLINO ALLIS CHALMER
        let gearThree = data.Data[17];
        // MOLINO 8X6
        let gearFour = data.Data[18];
        // CHANCADORA 1
        let gearFive = data.Data[19];
        // CHANCADORA 2
        let gearSix = data.Data[20];
        // CHANCADORA 3
        let gearSeven = data.Data[21];
        // **********************************************
