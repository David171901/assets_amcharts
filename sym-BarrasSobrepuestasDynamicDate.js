(function(CS) {
    ...
    var myEDcolumnDefinition = {
        typeName: "BarrasSobrepuestasDynamicDate",
        displayName: 'Barras sobrepuestas fecha dinamica',
    ...
    symbolVis.prototype.init = function(scope, elem) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                if (firstTurn.Values.length > 0) {
                    ...
                    fillDataArray(firstTurn, secondTurn, firstTurnReal, secondTurnReal, new Date(customStartDate.Value), daysOfMonth, dataArray, targetArray)
        ...
        function fillDataArray(firstTurn, secondTurn, firstTurnReal, secondTurnReal, start, daysOfMonth, dataArray, targetArray) {
            ...
            for (var dayIndex = 1; dayIndex < daysOfMonth; dayIndex++) {
                ...
                var newDataObject = getNewDataObject(iterableDate.getDate(), floatFirstTurn, floatSecondTurn, total, valTarget);
