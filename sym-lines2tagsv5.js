(function (BS) {
    ...
    var myCustomSymbolDefinition = {
        typeName: 'lines2tagsv5',
        displayName: 'Conductividad (Estaciones Hidrometricas)',
        inject: ['timeProvider'],
        datasourceBehavior: BS.Extensibility.Enums.DatasourceBehaviors.Multiple,
        iconUrl: '/Scripts/app/editor/symbols/ext/icons/LINES_COMM.png',
    ...
    symbolVis.prototype.init = function (scope, elem, timeProvider) {
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                if (scope.config.label1 == "") if (firstData.Label) scope.config.label1 = firstData.Label.split('|')[0];
                ...
                if (hasSecondData) {
                    ...
                    if (scope.config.label2 == "") if (secondData.Label) scope.config.label2 = secondData.Label.split('|')[0];
                ...
                "graphs": [
                    {
                        "id": "Line1",
                        "type": "smoothedLine",
                        "balloonText": scope.config.label1.split('|')[0] + ": <b>[[value1]] [[units1]] </b><br/>[[tiempo1]]",
                        "fontSize": scope.config.fontSize,
                        "labelPosition": "top",
                        "labelText": "[[value1]]",
                        "bullet": "round",
                        ...
                        "title": scope.config.label1.split('|')[0],
                        "valueAxis": "Axis1",
                        "valueField": "value1",
                        "showBalloon": true,
                    ...
                    },
                    {
                        "id": "Line2",
                        "type": "smoothedLine",
                        "balloonText": scope.config.label2.split('|')[0] + ": <b>[[value2]] [[units2]] </b><br/>[[tiempo2]]",
                        "fontSize": scope.config.fontSize,
                        "labelPosition": "top",
                        "labelText": "lalal",
                        "bullet": "round",
                        ...
                        "title": scope.config.label2.split('|')[0],
                        "valueAxis": "Axis1",
                        "valueField": "value2",
                        "showBalloon": true,
                        "dashLengthField": "dashLengthLine"
        ...
        function myCustomConfigurationChangeFunction() {
            if (chart) {
                ...
                if (chart.graphs[0]) {
                    chart.graphs[0].title = scope.config.label1.split('|')[0];
                    chart.graphs[0].balloonText = scope.config.label1.split('|')[0] + ": <b>[[value1]] " + scope.config.units1 + " </b><br/>[[tiempo1]]";
                }

                if (chart.graphs[1]) {
                    chart.graphs[1].title = scope.config.label2.split('|')[0];
                    chart.graphs[1].balloonText = scope.config.label2.split('|')[0] + ": <b>[[value2]] " + scope.config.units2 + " </b><br/>[[tiempo2]]";
                }
