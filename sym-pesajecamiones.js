(function (BS) {
    ...
    var myCustomSymbolDefinition = {
        typeName: 'pesajecamiones',
        displayName: 'Pesaje Camiones',
    ...
    symbolVis.prototype.init = function (scope, elem) {
        console.log('\t[+]Pesaje caminones loaded')
        scope.symbol.Configuration.Intervals = 1000;
        ...
        function myCustomDataUpdateFunction(data) {
            ...
            if (data !== null && data.Data) {
                ...
                if (scope.config.stringLabel1 == "") if (itemsValues1.Label) scope.config.stringLabel1 = itemsValues1.Label.split('|')[1];
                if (scope.config.stringUnits1 == "") if (itemsValues1.Units) scope.config.stringUnits1 = itemsValues1.Units.split('|')[1];

                if (scope.config.stringLabel2 == "") if (itemsValues2.Label) scope.config.stringLabel2 = itemsValues2.Label.split('|')[1];
                if (scope.config.stringUnits1 == "") if (itemsValues2.Units) scope.config.stringUnits2 = itemsValues2.Units.split('|')[1];

                if (scope.config.stringLabel3 == "") if (itemsValues3.Label) scope.config.stringLabel3 = itemsValues3.Label.split('|')[1];
                if (scope.config.stringUnits3 == "") if (itemsValues2.Units) scope.config.stringUnits3 = itemsValues3.Units.split('|')[1];

            
                for (var i = 0; i < itemsValues1.Values.length; i++) {                                        
                    var horas = (new Date(itemsValues1.Values[i].Time)).getDate();
