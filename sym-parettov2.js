(function (BS) {
    ...
    symbolVis.prototype.init = function (scope, elem) {
        ...
        function myCustomDataUpdateFunction(data) {
            console.log("ParettoCharts v2",data);
            ...
            if (data) {
                ...
                console.log(" ~ file: sym-parettov2.js ~ line 77 ~ myCustomDataUpdateFunction ~ items", items)
                ...
                for (var i = 0; i < items.length; i++) {
                    ...
                    let itemValue = parseFloat((("" + item.Value)).replace(",", "")).toFixed(0);
