(function (PV) {
    ...
    PV.deriveVisualizationFromBase(symbolVis);
      ...
      symbolVis.prototype.init = function(scope, elem) {
          ...
          console.log('[+] Valvula Loaded');
          
          const bombaGif = '<img class = "flex" src="./Scripts/app/editor/symbols/ext/content/images/vnOpen.png">';
          const bombaStatic = '<img class = "flex" src="./Scripts/app/editor/symbols/ext/content/images/vnClose.png">';
  
          let symbolContainerDiv = elem.find('#valvula')[0];
          ...
          function myCustomDataUpdateFunction(data) {
              ...
              if (isActive == '1' || parseInt(isActive) == 1 || isActive == 'Sobrecarga' || isActive == 'Arrancando' || isActive == true || isActive == 'Active' || isActive == 'active' || isActive == 'true' || isActive == 'True' || isActive == 'Encendido' || isActive == 'encendido') {
                  console.log('\t[+] Valvula Open');
                  container.html(bombaGif);
              } else {
                  console.log('\t[-] Valvula Close');
