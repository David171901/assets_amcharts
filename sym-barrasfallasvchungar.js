...
(function (CS) {
  ...
  symbolVis.prototype.init = function (scope, elem, timeProvider) {
    console.log("\t[+]Barras Fallas Chungar");
    ...
    function fillDataArray(
      ...
      if (
        new Date(timeProvider.displayTime.start).getMonth() == 0 &&
        new Date(timeProvider.displayTime.start).getDate() == 1
      ) {
        daysOfMonth_ = 0;
        moreDays = 27;
      }
    ...
    function setValueAxisYToMargin(dataArray) {
      ...
      scope.config.maximumYValueAxisv2 < 5200
        ? (scope.config.maximumYValueAxisv2 = 5200)
        : true;
    }
